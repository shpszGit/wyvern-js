                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (isParityNode || isTestRpc) {
                            ...
                            orderHashBuff = ethereumjs_util_1.toBuffer(orderHash);
                            msgHashBuff = ethereumjs_util_1.hashPersonalMessage(orderHashBuff);
                            msgHashHex = ethereumjs_util_1.bufferToHex(msgHashBuff);
                        }
